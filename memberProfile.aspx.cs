    ...
    public partial class memberProfile : System.Web.UI.Page
    {
        ...
        void updateMemberDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_tbl set full_name=@full_name, dob=@dob, contact_no=@contact_no," +
                    " email=@email, member_type=@member_type, postcode=@postcode, address=@address, password=@password, " +
                ...
                cmd.Parameters.AddWithValue("@member_type", DropDownList1.SelectedItem.Value);
        ...
        void findMemberData()
        {
            try
            {
                ...
                DropDownList1.SelectedValue = dt.Rows[0]["member_type"].ToString().Trim();
        ...
        void findUserBookData()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from lending_tbl where member_id='" + Session["username"].ToString() + "';", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
